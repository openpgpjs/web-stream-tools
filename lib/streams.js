import * as ponyfill from 'web-streams-polyfill/ponyfill/es6';
...
const { ReadableStream, WritableStream, TransformStream } = global.TransformStream ? global : ponyfill;

const toPonyfillReadable = global.ReadableStream &&
