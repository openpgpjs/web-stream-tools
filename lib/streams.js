...
async function loadStreamsPonyfill() {
  ...
  ({ ReadableStream, WritableStream, TransformStream } = await import('web-streams-polyfill/ponyfill/es6'));
...
export { ReadableStream, WritableStream, TransformStream, ArrayStream, loadStreamsPonyfill, isStream, isArrayStream, isUint8Array, toStream, concatUint8Array, concatStream, concat, getReader, getWriter, pipe, transformRaw, transform, transformPair, parse, clone, passiveClone, slice, readToEnd, cancel, fromAsync, nodeToWeb, webToNode };
